      ...
      'markers': L.geoJson(null, {        
        ...
        onEachFeature: function (feature, layer) {
          if (feature.properties) {
            ...
            content = content + "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Title</th><td>" + element.title + "</td></tr>" + "<tr><th>Last Detection</th><td>" + feature.properties.TIMESTAMP + "</td></tr>" + "<tr><th>Precision of Detection </th><td>" + Number(feature.properties.PRECISION).toFixed(2) + "% </td></tr>" + "</td></tr>" + "<tr><th>Total of Detections</th><td>" + feature.properties.TOTALDETECTIONS + "</td></tr>" + "</td></tr>" + "<tr><th>Address</th><td>" + feature.properties.ADDRESS + "</td></tr><tr><th>ID</th><td>" + feature.id + "</td></tr><tr><th>Coordinates</th><td>" + feature.geometry.coordinates[1] + ", " + feature.geometry.coordinates[0] + "</td></tr><table>";
            layer.on({
              click: function (e) {
